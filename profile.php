...
<div class="ht__bradcaump__area" style="background: rgba(0, 0, 0, 0) url(images/bg/4.jpeg) no-repeat scroll center center / cover ;">
								...
								<form id="login-form" method="post">
									<div class="single-contact-form">
										<div class="contact-box name">
											...
											placeholder="Your Name*" style="width:100%" value="<?php echo $_SESSION['USER_NAME']?>">
										</div>
						...
						<div class="contact-form-wrap mt--60">
							...
							<div class="col-xs-12">
								<form method="post" id="frmPassword">
									...
									<div class="contact-btn">
										<button type="button" class="fv-btn" onclick="update_password()" id="btn_uodate_password">Update</button>
		...
		<script>
			...
			function update_password(){
				...
				if(new_password==''){
					jQuery('#new_password_error').html('Please enter your password');
					is_error='yes';
				}
				if(confirm_new_password==''){
					jQuery('#confirm_new_password_error').html('Please enter your password');
					is_error='yes';
				}
				...
				if(is_error==''){
					jQuery('#btn_uodate_password').html('Please wait...');
					jQuery('#btn_uodate_password').attr('disabled',true);
					jQuery.ajax({
						...
						success:function(result){
							...
							jQuery('#btn_uodate_password').html('Update');
							jQuery('#btn_uodate_password').attr('disabled',false);
