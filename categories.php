                        ...
                        <div class="htc__product__rightidebar">
                            <div class="htc__grid__top">
                                <div class="htc__select__option">
                                    <select class="ht__select" onchange="sort_product_drop('<?php echo $cat_id?>'
                            ...
                            <div class="row">
                                <div class="shop__grid__view__wrap">
                                    <div role="tabpanel" id="grid-view" class="single-grid-view tab-pane
                                     fade in active clearfix">
                                ...
                                <div class="category">
                                    ...
                                    <div class="fr__hover__info">
                                        <ul class="product__action">
                                            ...
                                            <li><a href="javascript:void(0)"  onclick="manage_cart
                                            ('<?php echo $list['id']?>?>','add')">
